...
export default function Cart() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      clearCart();
      setIsSuccess(orderNumber);
      setTimeout(() => navigate('/track'), 10000);
    } catch (error) {
       ...
       <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-8">
             <div className="flex items-center justify-between">
                <div>
                   <h2 className="text-4xl font-serif font-bold italic text-slate-800">Shopping Cart</h2>
                  ...
                  <div key={item.id} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm flex items-center justify-between group">
                     <div className="flex items-center gap-6">
                        ...
                        <div>
                           ...
                           <p className="text-xs font-bold text-saffron mt-1">₹{item.offerPrice || item.price}</p>
                        </div>
                     </div>
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <p className="font-bold text-slate-800 w-20 text-right">₹{(item.offerPrice || item.price) * item.quantity}</p>
                     </div>
                  </div>
                ))}
             ...
             <div className="bg-slate-900 rounded-[48px] p-10 text-white shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                   <div className="space-y-2">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-2">Full Name / Shop Name</p>
                   ...
                   <div className="space-y-2">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-2">Phone Number</p>
                      <div className="relative">
                         <input 
                            required
                            type="tel" 
                   ...
                   <div className="space-y-2">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-2">Full Address</p>
                      <div className="relative">
                         <input 
                            required
                            type="text" 
                   ...
                   <div className="space-y-2">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-2">Special Note (Optional)</p>
                      <div className="relative">
                         <textarea 
                            rows={2}
                   ...
                   <div className="space-y-2">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest pl-2">Route (Delivery Area)</p>
                      <div className="relative">
                         <select 
